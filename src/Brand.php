<?php
    ...
    class Brand
    {
        ...
        //Save individual brand name to brands table and auto assign an id
        function save()
        {
        ...
        //Delete all brands from brands table and join table
        ...
        //Get stores from the database by brand id using a join statement
        function getStores()
        {
